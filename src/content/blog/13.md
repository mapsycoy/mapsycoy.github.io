      ...
      ko: >-
        ...
        flowchart TB
            ...
            subgraph D20["Jul 20–22"]
                ...
                S2[07.21 · OpenAI 공시<br/>그 공격자는 자사 모델]
            end
      ...
      en: >-
        ...
        flowchart TB
            subgraph D16[Thu, Jul 16]
                ...
                S1[Hugging Face detects and blocks<br/>an unidentified AI cyberattack]
            end
            ...
            subgraph D20[Jul 20–22]
                ...
                S2[Jul 21 · OpenAI disclosure<br/>The attacker was their own model]
            end
            ...
            subgraph D27[Mon, Jul 27"]
                ...
                A[Amodei's counter-statement<br/>Never called for a ban]
                O[NVIDIA-led alliance<br/>launches OSAA · 37 members]
            end
