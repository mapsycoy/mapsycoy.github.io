...
seriesOrder: 3
summary:
  ko: CHI 2026의 아동 연구를 검토하며, 만 13세 이하 일반 발달 아동의 상상력과 주체성을 다루는 국내 HCI 연구의 공백을 구체화합니다.
  en: A review of child-focused work at CHI 2026 clarifies a research gap around imagination and agency among typically developing children under thirteen.
thumbnail: https://chi2026.acm.org/wordpress/wp-content/uploads/2024/09/chi-banner-full.png
heroImage: https://chi2026.acm.org/wordpress/wp-content/uploads/2024/09/chi-banner-full.png
heroImageCaption:
  ko: ""
  en: ACM CHI 2026
contentBlocks:
  - type: text
    body:
      en: >-
        ...
        papers as the first post in the 'paper review' category.
        ...
        *(Note that ｢Endless Swipes and Recommendations｣ won an Honorable Mention, but is not included here as it significantly deviates from the criteria.)*
        ...
        ## The Trajectory of Child and Youth AI Research at DxD Lab
        ...
        ## FutureMe, the Closest Match to These Criteria
      ...
      ko: >-
        > 최근 웹사이트를 개편한 만큼, 'Paper Review' 카테고리의 첫 정식 포스팅으로 CHI 2026 논문들을 다뤄보고자 한다.
        ...
        *(주의: ｢Endless Swipes and Recommendations｣는 Honorable Mention을 수상했으나, 본 글의 기준에서 크게 벗어나므로 여기서는 제외했다.)*
        ...
        ## DxD Lab으로 이어지는 국내 아동·청소년 AI 연구의 흐름
