...
seriesOrder: 8
summary:
  ko: 앞선 글의 설계 원칙이 첫 글이 경계했던 AI마저 정당화한다는 모순에서 출발해, 행위성의 느낌과 의미를 만드는 노동을 갈라냅니다.
  en: Starting from a contradiction—the previous principle also justifies the AI
    the first essay warned against—this essay splits the feeling of agency from
    the labor of making meaning.
    ...
    body:
      ko: >-
        ...
        ***분기를 늘리는 대신, 사용자의 노력이 인정되고 되돌아오는 구조***
        ...
        스토리형 게임 글에서 나는 Wegner의 *apparent mental causation*을 빌려 왔다. 
        ...
        * **배타성(Exclusivity)**: 그 행동의 다른 그럴듯한 원인이 눈에 띄지 않을 것
        ...
        Wegner & Wheatley(1999)의 'I Spy' 실험[^1]은 우리가 의식적으로 인지하는 '내 의지'가 실제 행동을 일으킨 직접적인 원인이 아니라, 뇌가 만들어낸 사후 해석(착각)일 수 있다는 것을 보여준다.
