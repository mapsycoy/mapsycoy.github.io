...
seriesOrder: 5
summary:
  ko: 안전과 몰입, 개인화와 프라이버시, 보호와 자율성의 충돌을 통해 아동용 대화형 AI 설계가 피할 수 없는 세 가지 딜레마를 정리합니다.
  en: Three tensions—safety versus engagement, personalization versus privacy, and protection versus autonomy—define the dilemmas of conversational AI for children.
thumbnail: https://cdn.jsdelivr.net/gh/mapsycoy/mapsycoy-assets@3698d9c/uploads/blog/dilemmas.webp
heroImage: https://cdn.jsdelivr.net/gh/mapsycoy/mapsycoy-assets@3698d9c/uploads/blog/dilemmas.webp
heroImageCaption:
