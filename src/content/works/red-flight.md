...
contentBlocks:
  - type: text
    body:
      ko: >-
        RED Flight는 롤플레잉을 통해 AI 탈옥(jailbreaking)을 쉽게 접할 수 있도록 만든 프로젝트입니다.


        프롬프트 기반의 미션을 통해 레드티밍(red-teaming) 개념을 인터랙티브한 챌린지로 전환하여, 사용자가 LLM의 한계를 테스트할 수 있도록 합니다. 저는 네이밍, 세계관 구축, 콘텐츠 제작 등 프로젝트의 아이덴티티를 형성하는 작업을 진행했습니다.


        이 프로젝트는 2024년 IVS Crypto에서 파이널리스트로 선정되었으며, 이후 카이아 스퀘어 라운지에 엠버서더로 참여하였습니다.
      en: >-
...
tags:
  - AI
thumbnail: https://cdn.jsdelivr.net/gh/mapsycoy/mapsycoy-assets@3698d9c/uploads/works/red-ivs.webp
heroImage: https://cdn.jsdelivr.net/gh/mapsycoy/mapsycoy-assets@3698d9c/uploads/works/red.webp
